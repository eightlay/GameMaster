...
def user_profile_start(update: Update, context: CallbackContext):
...
def user_profile_name(update: Update, context: CallbackContext):
...
def user_profile_age(update: Update, context: CallbackContext):
...
def user_profile_status(update: Update, context: CallbackContext):
...
def user_profile_edit(update: Update, context: CallbackContext):
